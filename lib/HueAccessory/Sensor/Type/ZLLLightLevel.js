...
class ZLLLightLevel extends AbstractSensor {
  ...
  updateCharacteristics() {
    this.accessory
      ...
      .updateCharacteristic(this.Characteristic.CurrentAmbientLightLevel, Math.round(Math.pow(10, (this.cachedSensor.state.lightLevel - 1) / 10000)))
    ...
    this.accessory
      ...
      .on('get', callback => {
        this.sensor.then(sensor => {
          callback(null, Math.round(Math.pow(10, (sensor.state.lightLevel - 1) / 10000)));
        });
      })
    ;
