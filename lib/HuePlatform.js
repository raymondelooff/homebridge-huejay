      ...
      client.lights.getAll()
        .then(lights => {
          for (const light of lights) {
            ...
            try {
              this.accessoryFactory.addLightServicesToAccessory(accessory, client, light);

              if (this.config.enableGenericLightSupport && accessory.context.generic !== true) {
        ...
        .then(sensors => {
          for (const sensor of sensors) {
            ...
            try {
              ...
              if (this.config.enableGenericSensorSupport && accessory.context.generic !== true) {
                this._registerPlatformAccessory(accessory);
              }
            } catch (err) {
              this.log.debug(err.message);
